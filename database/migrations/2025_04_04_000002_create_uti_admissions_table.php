...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('uti_admissions', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('medico_responsable_id')->nullable();
            ...
            $table->foreign('seguro_id')->references('codigo')->on('seguros');
            $table->foreign('medico_responsable_id')->references('id')->on('medicos');
        });
    }
