...
class CajaTestDataSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $existingConsultas = DB::table('consultas')->count();
        
        if ($existingConsultas == 0) {
            // Insertar especialidad GENERAL si no existe
            ...
            $this->commandInfo('Datos de prueba para caja creados exitosamente');
        } else {
            $this->commandInfo('Ya existen datos en la base de datos');
        }
    }
}
