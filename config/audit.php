...
return [
    ...
    */
    'descriptions' => [
        ...
        'admin.cirugias-externas.verificar-pago'           => 'verificó el pago de una cirugía externa',
        'admin.cirugias-externas.rechazar'                 => 'rechazó una cirugía externa',
        'admin.cirugias-externas.qr.update'                => 'actualizó el QR de pago de cirugías externas',
        'admin.cirugias-externas.qr.destroy'               => 'eliminó el QR de pago de cirugías externas',
        'admin.tipos-cirugia-externa.update'               => 'actualizó precios de cirugías externas',
        'cirugias-externas.public.store'                   => 'registró una solicitud de cirugía externa (público)',
        ...
        'caja.gestion.devoluciones.store'                  => 'registró una devolución (nota de crédito)',
        'caja.gestion.devoluciones.anular'                 => 'anuló una devolución',
        'caja.gestion.devoluciones.revertir'               => 'revirtió la anulación de una devolución',
        'farmacia.ventas.anular'                           => 'anuló una venta de farmacia (devolución con reingreso de stock)',
