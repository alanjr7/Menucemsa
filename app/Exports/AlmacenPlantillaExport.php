...
class AlmacenPlantillaExport implements FromArray, ShouldAutoSize, WithHeadings, WithTitle
{
    ...
    {
        return [
            'nombre', 'nombre_generico', 'concentracion', 'forma_farmaceutica', 'categoria',
            'codigo_atc', 'codigo_liname', 'requiere_receta',
    ...
    {
        return [
            ['Omeprazol 20mg cápsula', 'Omeprazol', '20mg', 'cápsula', 'Gastrointestinal', 'A02BC01', 'A 02 02', 0, 100, 'medicamento', 'unidades', 20, 'Distribuidora ABC', 'Genérico', 'L-2026-001', 'F-12345', 100, '2027-12-31', 0.50, 1.00, 'Antiácido'],
            ['Omeprazol 20mg cápsula', 'Omeprazol', '20mg', 'cápsula', 'Gastrointestinal', 'A02BC01', 'A 02 02', 0, 50, 'medicamento', 'unidades', 20, 'Farma SRL', 'Bagó', 'L-2026-002', 'F-12346', 50, '2026-10-31', 0.80, 1.50, ''],
