    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('emergency-staff.show', $emergency) }}" class="btn btn-secondary">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('emergency-staff.update', $emergency) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="symptoms" id="symptoms" rows="3" 
                                              class="form-control @error('symptoms') is-invalid @enderror">{{ old('symptoms', $emergency->symptoms) }}</textarea>
                                    @error('symptoms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    <h6><i class="fas fa-info-circle"></i> Información del Paciente</h6>
