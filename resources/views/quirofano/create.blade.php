                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="fecha" id="fecha" placeholder="YYYY-MM-DD" pattern="\d{4}-\d{2}-\d{2}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Hora de Inicio Estimada *</label>
                                <input type="text" name="hora_inicio_estimada" id="hora_inicio" placeholder="HH:MM" pattern="\d{2}:\d{2}" maxlength="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <select name="nro_quirofano" id="quirofano" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                                    ...
                                    @foreach($quirofanos as $quirofano)
                                        <option value="{{ $quirofano->nro }}" data-tipo="{{ $quirofano->tipo }}">Quirófano {{ $quirofano->nro }} - {{ $quirofano->tipo }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="ci_instrumentista" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <select name="ci_anestesiologo" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
