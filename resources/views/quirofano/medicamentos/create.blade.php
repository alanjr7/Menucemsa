...
@section('title', 'Agregar Medicamento - Quirófano')
...
<div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Añadir nuevo item al inventario de quirófano</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('quirofano.medicamentos.store') }}" method="POST" class="space-y-6">
            @csrf
