...
<div class="w-full p-6 bg-gray-50/50 min-h-screen">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Historial de Médicos</h1>
            <p class="text-sm text-gray-500">Selecciona un médico para ver su historial completo de consultas</p>
        </div>
        <div class="flex gap-3">
            ...
            <a href="{{ route('consulta.pacientes-medicos') }}" class="flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-medium transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            <h2 class="text-lg font-bold text-gray-800">Médicos Registrados</h2>
            <p class="text-sm text-gray-500 mt-1">Total: {{ $medicos->count() }} médicos en el sistema</p>
        </div>
        
        <div class="divide-y divide-gray-100">
            @forelse($medicos as $medico)
                <div class="p-6 hover:bg-gray-50 transition cursor-pointer" onclick="window.location.href='{{ route('consulta.historial-medico', $medico->ci) }}'">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="text-right">
                                <div class="text-sm font-medium text-gray-700">Ver historial</div>
                                <div class="text-xs text-blue-600">Click para detalles →</div>
                            </div>
