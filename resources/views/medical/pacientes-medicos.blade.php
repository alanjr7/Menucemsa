                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                                {{ substr(optional($medico->user)->name, 0, 1) }}{{ substr(explode(' ', optional($medico->user)->name)[1] ?? '', 0, 1) }}
                            </div>
                            <div>
                                <h3 class="text-lg font-semibold text-gray-800">{{ optional($medico->user)->name ?? 'Sin nombre' }}</h3>
