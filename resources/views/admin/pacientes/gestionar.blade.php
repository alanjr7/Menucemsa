...
<div class="w-full p-6 bg-gray-50/50 min-h-screen">
        ...
        <div class="flex justify-between items-end mb-8">
            <div>
                ...
                <p class="text-sm text-gray-500">Panel administrativo para gestión de pacientes</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            ...
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-500">Cuentas Pendientes</p>
                        <p class="text-2xl font-bold text-orange-600">{{ $stats['con_cuentas_pendientes'] }}</p>
                    </div>
        ...
        <form method="GET" class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 mb-6 flex flex-col md:flex-row gap-4">
            ...
            @if(request('search') || request('estado'))
                <a href="{{ route('admin.pacientes.gestionar') }}" class="flex items-center justify-center px-4 py-2.5 border border-gray-200 rounded-xl text-gray-600 bg-white hover:bg-gray-50 font-medium transition-colors shadow-sm">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <table class="min-w-full divide-y divide-gray-100">
                    <thead class="bg-gray-50/50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">Acciones Administrativas</th>
                        </tr>
                    </thead>
