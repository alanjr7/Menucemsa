    ...
    function aplicarFiltros() {
        ...
        let filtrados = datosCompletos.filter(emp => {
            const matchBuscar = !buscar || 
                ...
                (emp.paciente_ci || '').toLowerCase().includes(buscar);
        ...
        tbody.innerHTML = emergencias.map(emp => `
            <tr class="bg-white border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-4">
                    ...
                    <div class="text-xs text-gray-500">${emp.is_temp ? 'ID Temporal' : 'CI: ' + emp.paciente_ci}</div>
                </td>
                <td class="px-6 py-4">
        ...
        contenido.innerHTML = `
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <p><strong>CI:</strong> ${emp.paciente_ci}</p>
                    <p><strong>Tipo:</strong> ${emp.is_temp ? 'ID Temporal' : 'Paciente Registrado'}</p>
                </div>
                <div>
