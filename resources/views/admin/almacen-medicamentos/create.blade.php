        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Información del Catálogo</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="descripcion" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg">{{ old('descripcion') }}</textarea>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Observaciones</label>
                            <textarea name="observaciones" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg">{{ old('observaciones') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <!-- Primer lote -->
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Primer Lote (Almacén Central)</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="codigo_lote" value="{{ old('codigo_lote') }}" maxlength="100"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg" placeholder="Ej: L-2026-001">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="number" name="precio_compra" x-model="precioCompra" step="0.01" min="0"
                                   value="{{ old('precio_compra') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">% Ganancia</label>
                            <input type="number" name="porcentaje_ganancia" x-model="porcentaje" step="0.1" min="0" max="999"
                                   value="{{ old('porcentaje_ganancia') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Precio de venta (Bs)</label>
                            <input type="number" name="precio_venta" :value="precioVenta" step="0.01" min="0"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50">
                            <p class="text-xs text-gray-400 mt-1">Auto-calculado: compra × (1 + ganancia%)</p>
                        </div>
                    </div>
                </div>
