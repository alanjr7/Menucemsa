...
<div class="w-full p-6 bg-gray-50/50 min-h-screen">
    ...
    <div class="flex justify-between items-end mb-8">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('patients.print', $paciente->ci) }}" target="_blank" class="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
