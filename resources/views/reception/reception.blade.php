...
<div class="w-full p-6 bg-gray-50/50 min-h-screen">
    ...
    <script>
        ...
        // Función para habilitar/deshabilitar campos de consulta externa
        // NOTA: Solo afecta campos dentro de la sección de consulta externa, NO el modal de cita
        function habilitarCamposConsulta(habilitar) {
            // Buscar solo dentro del formulario de consulta externa (tab consulta)
            const consultaSection = document.getElementById('tab-consulta');
            if (!consultaSection) return;
            ...
            camposConsulta.forEach(selector => {
                // Buscar solo dentro de la sección de consulta externa
                const campo = consultaSection.querySelector(selector);
                if (campo) {
