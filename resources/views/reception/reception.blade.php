<x-app-layout>
    ...
    <div id="modalConsultaExterna" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <!-- Header del Modal -->
            <div class="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-t-2xl">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="text-2xl font-bold">Consulta Externa</h3>
                        <p class="text-green-100 text-sm mt-1">Registrar nuevo paciente o abrir episodio existente</p>
                    </div>
                    <button onclick="cerrarModalConsultaExterna()" class="bg-white/20 hover:bg-white/30 p-2 rounded-full transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                    </button>
            ...
            <div class="p-6">
                <form id="formConsultaExterna" onsubmit="registrarConsultaExterna(); return false;">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">C.I. / Carnet de Identidad</label>
                                <div class="flex gap-2">
                                    <input type="text" id="paciente_ci" name="ci" placeholder="Número de CI" class="flex-1 border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 transition-all" required>
                                    <button type="button" onclick="buscarPaciente()" class="bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-2.5 rounded-xl transition-colors text-sm">
                                        Buscar
                                    </button>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="tipo_paciente" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 transition-all" required>
                                    <option value="">Seleccione...</option>
                        ...
                        <div id="datosPersonales" class="mt-4 p-4 bg-white rounded-xl border border-gray-200 hidden">
                            <h5 class="font-semibold text-gray-800 mb-3">Datos Personales</h5>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Nombres *</label>
                                    <input type="text" name="nombres" placeholder="Nombres completos" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 transition-all">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Apellidos *</label>
                                    <input type="text" name="apellidos" placeholder="Apellidos completos" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 transition-all">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Fecha de Nacimiento</label>
                                    <input type="date" name="fecha_nacimiento" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 transition-all">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="telefono" placeholder="Número de teléfono" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 transition-all">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Correo Electrónico</label>
                                    <input type="email" name="correo" placeholder="correo@ejemplo.com" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 transition-all">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 rounded-xl p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Especialidad</label>
                                <select name="especialidad" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" required>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Médico</label>
                                <select name="medico" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" required>
                                    <option value="">Seleccione médico...</option>
                                    <option value="dr_ramirez">Dr. Ramírez, Carlos</option>
                                    <option value="dra_torres">Dra. Torres, Ana</option>
                                    <option value="dr_silva">Dr. Silva, Luis</option>
                                </select>
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Tipo de Seguro</label>
                                <select name="seguro" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" required>
                                    <option value="">Seleccione...</option>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Motivo de Consulta</label>
                                <input type="text" name="motivo" placeholder="Motivo principal de la consulta" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" required>
                            </div>
                        </div>

                        <div class="mt-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Observaciones Adicionales</label>
                            <textarea name="observaciones" rows="3" placeholder="Detalles adicionales..." class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"></textarea>
                        </div>
                    </div>

                    <!-- Información de Referencia a Caja -->
                    <div class="bg-yellow-50 rounded-xl p-4 mb-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-800">Registrar consulta</p>
                                    <p class="text-xs text-gray-600">Se registrará la consulta en el sistema</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-800">Paciente pasa a caja</p>
                                    <p class="text-xs text-gray-600">El paciente debe dirigirse a caja para pagar y obtener factura</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-600">Tras el pago, el médico podrá ver al paciente</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Botones de Acción -->
                    <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                        <button type="button" onclick="cerrarModalConsultaExterna()" class="px-6 py-2.5 border border-gray-200 rounded-xl text-gray-700 font-medium hover:bg-gray-50 transition-colors text-sm">
                            Cancelar
                        </button>
