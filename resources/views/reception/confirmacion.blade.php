...
@section('content')
    <div class="p-6 bg-gray-50/50 min-h-screen">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-2xl shadow-lg p-8 mb-6">
                <div class="text-center">
                    ...
                    <h1 class="text-3xl font-bold mb-2">¡Consulta Registrada Exitosamente!</h1>
                    <p class="text-green-100">El paciente ha sido registrado y el pago procesado correctamente</p>
                </div>
            </div>
                    ...
                    <div class="bg-green-50 rounded-xl p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="text-center">
                                ...
                                <p class="font-mono text-sm font-bold">{{ $caja->nro_factura }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-yellow-50 rounded-xl p-4">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-800">El paciente está listo para ser atendido</p>
                                    <p class="text-xs text-gray-600">El médico ya puede ver al paciente en su lista de consultas</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-800">Dirigirse al consultorio correspondiente</p>
                                    <p class="text-xs text-gray-600">El paciente debe esperar en la sala de espera hasta que lo llamen</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-800">Atención médica</p>
                                    <p class="text-xs text-gray-600">El médico realizará la consulta y emitirá recetas si es necesario</p>
                                </div>
                            </div>
                        </div>
                    </div>
