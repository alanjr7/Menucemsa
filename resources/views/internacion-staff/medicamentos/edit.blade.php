...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-3xl font-bold mb-6">Editar - Emergencia</h1>
    <form action="{{ route('emergency-staff.medicamentos.update', $medicamento) }}" method="POST" class="bg-white p-6 rounded shadow max-w-2xl">
        @csrf @method('PUT')
