...
@section('title', 'Editar Medicamento - Internación')
...
<div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('internacion-staff.medicamentos.show', $medicamento) }}" 
                ...
                <a href="{{ route('internacion-staff.medicamentos.index') }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('internacion-staff.medicamentos.update', $medicamento) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mt-6">
        ...
        <form action="{{ route('internacion-staff.medicamentos.stock', $medicamento) }}" method="POST" class="space-y-4">
            @csrf
