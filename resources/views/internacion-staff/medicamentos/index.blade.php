...
@section('title', 'Medicamentos de Internación')
...
<div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Medicamentos e Insumos de Internación</h1>
                <p class="text-gray-600 mt-1">Gestiona el inventario de medicamentos para internación</p>
            </div>
            <div class="flex gap-2">
                ...
                <a href="{{ route('internacion-staff.medicamentos.create') }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <form method="GET" action="{{ route('internacion-staff.medicamentos.index') }}" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="tipo" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div>
                    ...
                    <select name="estado_stock" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div>
                    ...
                    <select name="estado_vencimiento" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="">Todos</option>
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('internacion-staff.medicamentos.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg transition-colors">
                        Limpiar
                    </a>
                </div>
            </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('internacion-staff.medicamentos.edit', $medicamento) }}" 
                                       class="text-indigo-600 hover:text-indigo-900" title="Editar">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                        </svg>
                                    </a>
                                    <form action="{{ route('internacion-staff.medicamentos.destroy', $medicamento) }}" method="POST" 
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                No hay medicamentos ni insumos registrados en internación.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
