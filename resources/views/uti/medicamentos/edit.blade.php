...
@section('title', 'Editar Medicamento - UTI')
...
<div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('uti.operativa.medicamentos.show', $medicamento) }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('uti.operativa.medicamentos.update', $medicamento) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mt-6">
        ...
        <form action="{{ route('uti.operativa.medicamentos.stock', $medicamento) }}" method="POST" class="space-y-4">
            @csrf
